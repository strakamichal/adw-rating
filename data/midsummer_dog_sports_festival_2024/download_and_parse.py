#!/usr/bin/env python3
"""Download and parse Midsummer Dog Sports Festival 2024 results from Tolleri."""
...
COMPETITION_NAME = "Midsummer Dog Sports Festival 2024"
ORGANIZER_ID = "-306421049"
DATES = ["2024-06-20", "2024-06-21", "2024-06-22", "2024-06-23"]
...
def main():
    ...
    out_csv = BASE_DIR / "midsummer_dog_sports_festival_2024_results.csv"
